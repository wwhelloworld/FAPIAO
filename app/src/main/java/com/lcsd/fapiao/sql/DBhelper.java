...
public class DBhelper extends SQLiteOpenHelper {
    private static String DB_NAME = "CJDATA.db";//表示数据库的名称
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        //String sql = "create table CJHISTORY(id integer primary key autoincrement,code TEXT,number TEXT,date TEXT,amount TEXT)";
        //id超过整型范围改用varchar
        String sql = "create table CJHISTORY(id varchar(64) PRIMARY KEY,code varchar(64),number varchar(64),date varchar(64),amount varchar(64))";
        Log.e("创建表===", "创建！");
